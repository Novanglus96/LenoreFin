<template>
  <v-row class="pa-1 ga-1" no-gutters>
    <v-col class="rounded">
      <ContributionsWidget v-if="!isMobile" />
      <ContributionsWidgetMobile v-if="isMobile" />
    </v-col>
  </v-row>
  <v-row class="pa-1 ga-1" no-gutters>
    <v-col class="rounded">
      <ContributionRulesWidget v-if="!isMobile" />
      <ContributionRulesWidgetMobile v-if="isMobile" />
    </v-col>
  </v-row>
</template>
<script setup>
