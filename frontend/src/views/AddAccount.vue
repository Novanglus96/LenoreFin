<template>
    <v-form @submit.prevent>
        <v-card v-if="page1">
            ...
            <v-card-actions>
                <v-btn @click="page1 ? (page1 = false, page2 = true) : (page1 = true, page2 = false)" :disabled="next1">
                    Next
                </v-btn>
            </v-card-actions>
        </v-card>
        <v-card v-if="page2" min-height="500">
            ...
            <v-card-actions>
                ...
                <v-btn @click="submitForm" :disabled="submitDisabled">
                    Submit
                </v-btn>
            </v-card-actions>
        </v-card>
...
const checkNext = async () => {
    ...
    if (formData.value.apy !== null && formData.value.apy !== '' && formData.value.rewards_amount !== null && formData.value.rewards_amount !== '' && formData.value.credit_limit !== null && formData.value.credit_limit !== '' && formData.value.open_date !== null && formData.value.open_date !== '' && formData.value.opening_balance !== null && formData.value.opening_balance !== '') {
