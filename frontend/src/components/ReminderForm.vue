...
const formData = ref({
    ...
    reminder_source_account_id: props.passedFormData.reminder_source_account.id || null,
    reminder_destination_account_id: props.passedFormData.reminder_destination_account.id || null,
    ...
    watchEffect(() => {
        if (props.passedFormData) {
            formData.value = {
                ...
                reminder_source_account_id: props.passedFormData.reminder_source_account.id,
                reminder_destination_account_id: props.passedFormData.reminder_destination_account && props.passedFormData.reminder_destination_account.id ? props.passedFormData.reminder_destination_account.id : null,
            ...
            amount.value = props.passedFormData.amount ? parseFloat(Math.abs(props.passedFormData.amount)).toFixed(2) : null
        }
    })
}
...
const amount = ref(props.passedFormData.amount ? parseFloat(Math.abs(props.passedFormData.amount)).toFixed(2) : null)
const checkFormComplete = async () => {
    if (formData.value.transaction_type_id !== null 
        ...
        if (formData.value.transaction_type_id == 3) {
            if (formData.value.reminder_destination_account_id !== null && formData.value.reminder_destination_account_id !== '') {
