    ...
    try:
        ...
        if graph_type == "expense":
            ...
            for tag in report_main:
                ...
                this_year_data = [
                    abs(
                        sum(item.total_jan_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_feb_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_mar_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_apr_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_may_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_jun_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_jul_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_aug_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_sep_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_oct_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_nov_current for item in tag_group_totals)
                    ),
                    abs(
                        sum(item.total_dec_current for item in tag_group_totals)
                    ),
                    current_avg,
                ]
                last_year_data = [
                    abs(sum(item.total_jan_last for item in tag_group_totals)),
                    abs(sum(item.total_feb_last for item in tag_group_totals)),
                    abs(sum(item.total_mar_last for item in tag_group_totals)),
                    abs(sum(item.total_apr_last for item in tag_group_totals)),
                    abs(sum(item.total_may_last for item in tag_group_totals)),
                    abs(sum(item.total_jun_last for item in tag_group_totals)),
                    abs(sum(item.total_jul_last for item in tag_group_totals)),
                    abs(sum(item.total_aug_last for item in tag_group_totals)),
                    abs(sum(item.total_sep_last for item in tag_group_totals)),
                    abs(sum(item.total_oct_last for item in tag_group_totals)),
                    abs(sum(item.total_nov_last for item in tag_group_totals)),
                    abs(sum(item.total_dec_last for item in tag_group_totals)),
                    last_avg,
                ]
