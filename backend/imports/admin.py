...
from .models import (
    FileImport, TransactionImport, TransactionImportTag,
    TransactionImportError, TypeMapping, StatusMapping,
    AccountMapping, TagMapping,
)
...
class TransactionImportAdmin(ModelAdmin):
    list_display = ["file_import", "line_id", "transaction_date", "transaction_type_id",
                    "transaction_status_id", "amount", "description", "source_account_id",
                    "destination_account_id", "memo"]
...
class TransactionImportTagAdmin(ModelAdmin):
...
class TransactionImportErrorAdmin(ModelAdmin):
...
class TypeMappingAdmin(ModelAdmin):
...
class StatusMappingAdmin(ModelAdmin):
...
class AccountMappingAdmin(ModelAdmin):
...
class TagMappingAdmin(ModelAdmin):
