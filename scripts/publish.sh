...
worker_name="$app_name_prefix$worker_suffix"
...
docker rmi registry.danielleandjohn.love/$worker_name:latest
docker rmi novanglus96/$backend_name:latest
docker rmi novanglus96/$frontend_name:latest
docker rmi novanglus96/$worker_name:latest
...
docker tag $worker_name:production registry.danielleandjohn.love/$worker_name:$version_num
...
docker tag $worker_name:production novanglus96/$worker_name:$version_num
...
docker tag $worker_name:production registry.danielleandjohn.love/$worker_name:latest
...
docker push registry.danielleandjohn.love/$worker_name:$version_num
docker push novanglus96/$frontend_name:$version_num
docker push novanglus96/$backend_name:$version_num
docker push novanglus96/$worker_name:$version_num
...
docker push registry.danielleandjohn.love/$worker_name:latest
docker push novanglus96/$frontend_name:latest
docker push novanglus96/$backend_name:latest
docker push novanglus96/$worker_name:latest
